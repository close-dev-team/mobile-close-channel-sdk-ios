...
Then use a Personal Access Token (PAT) on GitHub as explained here as (described below) to clone the repository of the SDK framework binary. Use this token later when asked for a username and password for access to private repository.
